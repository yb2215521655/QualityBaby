...
public class CommentController {
    ...
    public ResponseJSON<List<Comment>> getAllTag(HttpServletRequest request) {
    ...
    public ResponseJSON delete(Comment comment){
